    ...
    return (
        <div className="focus_wrapper">
            <section className="hero">
                ...
                <img src="fusion_hero_background.png" alt="" />
            </section>
            <main className="fusionfocus_container">
                ...
                <section className="logo">
                    <Title text={"logo"} align={'flex-start'} />
                    <div className="logo-images">
                        <img src="/fusion_logo_2.png" alt="" />
                        <img src="/fusion_logo_1.png" alt="" />
                    </div>
                </section>
                <section className="onMac">
                    <Title text={"on Mac"} align={'flex-start'} />
                    <div className="onMac-images">
                        <img src="/onMac1.png" alt="" />
                        <img src="/onMac2.png" alt="" /> {/* Fixed file extension */}
                    </div>
                </section>
                <section className="productive_hours">
                    {/* <img className="number" src="/1.png" alt="" /> */}
                    ...
                    <img src="/Home_stats.png" className="home_stats" alt="" />
                </section>
                <section className="activity">
                    <div className="activity-1">
                        {/* <img src="/2.png" className="number" alt="" /> */}
                        <div className="left">
                            <Title text={"activity"} align={'flex-start'} />
                        ...
                        <img className="activity_img" src="/activity.png" alt="" />
                    </div>
                    <div className="activity-2">
                        <img className="activity_img" src="/Timeline.png" alt="" />
                        <div className="left">
                            <Title text={"activity"} align={'flex-start'} />
                    ...
                    <div className="activity-3">
                        <div className="left">
                            < Title text={"Default - List"} align={'flex-start'} />
                        ...
                        <img className="activity_img" src="/activity3.png" alt="" />

                    </div>
                </section>
                <section className="report">
                    {/* <img src="/3.png" alt="" className="number" /> */}
                ...
                <section className="limit">
                    {/* <img src="/4.png" alt="" className="number" /> */}
                    ...
                    <img className="limit_img" src="/limits.png" alt="" />
                ...
                <section className="strict">
                    ...
                    <div className="strict-header">
                        <div className="strict-wrapper">
                            <Title text={"strict mode"} align={'start'} />
                    ...
                    <div className="strict_bottom">
                        <div className="strict_left">
                            ...
                            <img className="app_png" src="/app.png" alt="" />
                        </div>
